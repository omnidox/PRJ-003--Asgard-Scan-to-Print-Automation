...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server" >
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="AA.Objects.AL.ALPrintLogMaint" 
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" TabIndex="3900">
		<Template>
		    ...
		    <px:PXSelector ID="edRecordID" runat="server" AutoRefresh="true" DataField="RecordID" />
            ...
            <px:PXFormView ID="templateDataForm" runat="server" DataMember="CurrentDocument" DataSourceID="ds" SkinID="Transparent">
                <Template>
                    <px:PXImageView ID="edImageUrl" runat="server" DataField="ImageUrl" Width="40%" Height="40%" AlreadyLocalized="True" CallbackUpdatable="True" />
                </Template>
            </px:PXFormView>
		</Template>
