...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="AA.Objects.AL.ALPrintJobProcess" PrimaryView="Filter">
        <CallbackCommands>
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <px:PXTab ID="tab" runat="server" Width="100%" Height="200px" DataSourceID="ds" FilesIndicator="False" NoteIndicator="False">
        <Items>
            <px:PXTabItem Text="Jobs">
                <Template>
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" TabIndex="3900" SkinID="Inquire" Height="400px" Width="100%" SyncPosition="true">
                        <CallbackCommands>
