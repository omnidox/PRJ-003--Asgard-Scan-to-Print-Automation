...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="AA.Objects.AL.ALPrintLogProcess" PrimaryView="Filter">
        <CallbackCommands>
            <%--            <px:PXDSCallbackCommand Name="EmailPhotoLog" Visible="False" />
            <px:PXDSCallbackCommand Name="DownloadZip" Visible="False" />--%>
            <%--<px:PXDSCallbackCommand Name="Render" DependOnGrid="grid" Visible="False" />--%>
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXSplitContainer runat="server" SplitterPosition="1100" ID="splitRender" Orientation="Vertical">
                        ...
                        <Template>
                            <px:PXGrid ID="grid" runat="server" AllowPaging="true" PageSize="15" DataSourceID="ds" TabIndex="3900" SkinID="Inquire" Height="400px" Width="100%" SyncPosition="true">
                                ...
                                <%--<ActionBar>
                                    ...
                                    <CustomItems>
                                        <px:PXToolBarButton Text="Email Photo Logs" AlreadyLocalized="False" SuppressHtmlEncoding="False" UsesSignalR="False">
                                            <AutoCallBack Command="EmailPhotoLog" Target="ds"></AutoCallBack>
                                        </px:PXToolBarButton>
                                        <px:PXToolBarButton Text="Export Photo Logs" AlreadyLocalized="False" SuppressHtmlEncoding="False" UsesSignalR="False">
                                            <AutoCallBack Command="DownloadZip" Target="ds"></AutoCallBack>
                                        </px:PXToolBarButton>
                                    </CustomItems>
                                </ActionBar>--%>
        ...
        <Template2>
            <%--<px:PXTreeView ID="tree" runat="server" DataSourceID="ds" DataMember="Filter" Height="0"
                AutoRepaint="True" SyncPosition="True" SyncPositionWithGraph="True" PreserveExpanded="True" ExpandDepth="0" PopulateOnDemand="True"
                Caption="Viewer" ShowRootNode="False" AllowCollapse="True">
