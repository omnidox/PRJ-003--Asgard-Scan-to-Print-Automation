...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Setup" TypeName="AA.Objects.Labels.ALPrinterFileProcess">
		<CallbackCommands>
...
<%--                                <RowTemplate>
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="Name" Width="270px" LinkCommand="ViewPrinterFile"/>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="FontFiles" DataKeyNames="PrinterFileGUID">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="Active" Type="CheckBox" Width="60px" TextAlign="Center" />
                                    <px:PXGridColumn DataField="Status" Type="DropDownList"/>
                                    <px:PXGridColumn DataField="Name" Width="180px" LinkCommand="ViewPrinterFile"/>
                                    ...
                                    <px:PXGridColumn DataField="Extension" Width="90px"/>
                                    <px:PXGridColumn DataField="Description" Width="280px"/>
                                    <px:PXGridColumn DataField="FontStyle" Type="DropDownList"/>
                                    <px:PXGridColumn DataField="Size"/>
                                    <px:PXGridColumn DataField="Width"/>
                                    <px:PXGridColumn DataField="Height"/>
