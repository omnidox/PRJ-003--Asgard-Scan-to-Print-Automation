...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" Width="100%" runat="server" Visible="True" PrimaryView="Model" TypeName="AA.Objects.Labels.ALModelMaint">
        <CallbackCommands>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXSplitContainer runat="server" SplitterPosition="1200" ID="splitRender" Orientation="Vertical">
                ...
                <Template>
                    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
                        ...
                        <Template>
                            ...
                            <px:PXTextEdit ID="edCloudID" runat="server" DataField="CloudID" CommitChanges="True" Enabled="false" />
                            ...
                            <px:PXUploadDialog ID="uploadLabelZoom" runat="server" AutoSaveFile="true" Caption="Upload Label Zoom XML" Key="Model__LabelZoom"
                                Height="110px" SessionKey="XmlUploadLabelZoom" AllowedFileTypes=".lbxml;" />
                        </Template>
                    </px:PXFormView>
                    <px:PXTab ID="tab" runat="server" Height="500px" Width="100%" DataSourceID="ds" DataMember="CurrentModel">
                        ...
                        <Items>
                            ...
                            <px:PXTabItem Text="Expressions" BindingContext="VisibilityForm" VisibleExp="DataControls[&quot;chkShowExprs&quot;].Value == true">
                                <Template>
                                    <px:PXGrid ID="exprGrid" runat="server" DataSourceID="ds" Height="150px" SkinID="Details" TabIndex="6800" Width="100%" ActionsPosition="Top"
...
Try to change filter to see records here."></EmptyMsg>
                                        <Levels>
                                            <px:PXGridLevel DataMember="Expressions">
                                                <RowTemplate>
                                                ...
                                                <Columns>
                                                    ...
                                                    <px:PXGridColumn DataField="LineNbr" Width="50px" TextAlign="Right" />
                                                    <px:PXGridColumn DataField="Active" Width="60px" TextAlign="Center" Type="CheckBox" />
                                                    <px:PXGridColumn DataField="ExprCode" Width="110px" />
                                                    <px:PXGridColumn DataField="DataElementID" Width="220px" CommitChanges="True" AllowDragDrop="True" LinkCommand="ViewDataElement" />
                                        ...
                                        <ActionBar>
                                            ...
                                            <CustomItems>
                                                <px:PXToolBarButton CommandSourceID="ds" CommandName="LoadLabelZoomDetails" Text="Pos" Tooltip="Load Label elements associated with the CloudID from the LabelZoom site">
                                                    <AutoCallBack Command="LoadLabelZoomDetails" Target="ds"></AutoCallBack>
                                                </px:PXToolBarButton>
                                                <px:PXToolBarButton CommandSourceID="ds" CommandName="ClearLabelZoomDetails" Text="Pos" Tooltip="Delete Details">
                                                    <AutoCallBack Command="ClearLabelZoomDetails" Target="ds"></AutoCallBack>
                                                </px:PXToolBarButton>
                                            </CustomItems>
                                        </ActionBar>
...
Try to change filter to see records here." />
                                        <Levels>
                                            <px:PXGridLevel DataMember="Graphics">
                                                <RowTemplate>
                                                ...
                                                <Columns>
                                                    ...
                                                    <px:PXGridColumn DataField="LabelZoomID" />
                                                    ...
                                                    <px:PXGridColumn DataField="SizeUnit" Width="90px" CommitChanges="True" Type="DropDownList"/>
...
Try to change filter to see records here."></EmptyMsg>
                            ...
                            <px:PXTabItem Text="Setup" BindingContext="VisibilityForm" VisibleExp="DataControls[&quot;chkShowSetup&quot;].Value == true">
                                <Template>
                                    ...
                                    <px:PXCheckBox runat="server" ID="chkMergeDetails" DataField="MergeDetails" CommitChanges="true" />
                                    <px:PXCheckBox runat="server" ID="chkPrintDetails" DataField="PrintDetails" CommitChanges="true" />
                                    ...
                                    <px:PXNumberEdit ID="edDefaultSize" runat="server" DataField="DefaultSize" CommitChanges="True" />
                                    <px:PXDropDown ID="edSizeUnit" runat="server" DataField="SizeUnit" CommitChanges="True" Type="DropDownList"/>
...
Try to change filter to see records here." />
                                        <Levels>
                                            <px:PXGridLevel DataMember="PrintLog">
                                                <RowTemplate>
            ...
            <Levels>
                <px:PXGridLevel DataMember="SelectedDataElements">
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="PrinterFileGUID" Width="180" />
                    </Columns>
