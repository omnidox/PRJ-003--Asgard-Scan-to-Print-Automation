...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="AA.Objects.Labels.ALFontMaint" PrimaryView="Document" PageLoadBehavior="SearchSavedKeys">
        <CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" Width="100%" DataMember="Document" Caption="Rule">
        ...
        <Template>
            ...
            <px:PXDropDown ID="edLanguage" runat="server" DataField="Language" Width="300px" CommitChanges="true"/>
            ...
            <px:PXDropDown ID="edFamily" runat="server" DataField="Family" Width="150px" CommitChanges="true"/>
            <px:PXDropDown ID="edStyle" runat="server" DataField="Style" Width="150px" CommitChanges="true" AllowMultiSelect="true"/>
                    ...
                    <px:PXGrid ID="labelFormatGrid" runat="server" DataSourceID="ds" Height="150px" Style="border: 0px;"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="UsedByModels">
                                <RowTemplate>
                                    <px:PXSelector ID="edModelName" runat="server" DataField="ALModel__Name" />
                                </RowTemplate>
                                <Columns>
