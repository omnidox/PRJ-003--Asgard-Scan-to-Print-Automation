...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server" >
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="AA.Objects.Labels.ALStandardMaint" PrimaryView="Document" PageLoadBehavior="SearchSavedKeys">
		<CallbackCommands>
...
Try to change filter to see records here." />
                        <Levels>
                            <px:PXGridLevel DataMember="Details" DataKeyNames="StandardID,LineNbr">
                                <RowTemplate>
                                    <px:PXSelector ID="edCategoryCode" runat="server" DataField="CategoryCode" AlreadyLocalized="False" IsClientControl="True" AutoComplete="True" />
                                </RowTemplate>
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="CategoryCode" Width="200px" />
            ...
            <px:PXTabItem Text="Categories">
                <Template>
                    <px:PXGrid ID="gridCategories" runat="server" DataSourceID="ds" SkinID="DetailsInTab" Width="100%"
                        Height="150px" MatrixMode="True" TabIndex="1000">
                        <Levels>
                            <px:PXGridLevel DataMember="Categories" DataKeyNames="StandardID,CategoryCode">
                                <RowTemplate>
                                </RowTemplate>
                                <Columns>
                                    <px:PXGridColumn DataField="CategoryCode" Width="100px"/>
                                    <px:PXGridColumn DataField="Description" Width="400px" />
                                    <px:PXGridColumn DataField="LastModifiedByID" Width="150px" />
                                    <px:PXGridColumn DataField="LastModifiedDateTime" Width="150px" />
                                </Columns>
