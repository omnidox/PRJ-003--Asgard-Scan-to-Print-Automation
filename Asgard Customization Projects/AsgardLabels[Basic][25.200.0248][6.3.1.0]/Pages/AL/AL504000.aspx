...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="AA.Objects.Labels.ALPrintLogEnq" PrimaryView="Filter">
        <CallbackCommands>
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
...
<%--                    <px:PXSelector ID="edBAccountID2" runat="server" DataField="BAccountID" />
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="Description" Width="1200px"/>
