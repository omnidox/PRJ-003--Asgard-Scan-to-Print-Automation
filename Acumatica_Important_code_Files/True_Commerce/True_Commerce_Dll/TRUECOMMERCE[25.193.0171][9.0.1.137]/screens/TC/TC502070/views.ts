...
export class TCInvoiceFilterSO extends PXView  {
...
export class ARRegister extends PXView  {
	...
	@columnConfig({width: 70})	DocType : PXFieldState;
	@columnConfig({width: 140})	RefNbr : PXFieldState<PXFieldOptions.CommitChanges>;
	@columnConfig({width: 90})	DocDate : PXFieldState;
}