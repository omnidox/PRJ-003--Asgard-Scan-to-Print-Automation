...
export class TCPurchaseOrderFilter extends PXView  {
	...
	POStatus : PXFieldState<PXFieldOptions.CommitChanges>;
	IsUpdateTransactionStatus : PXFieldState<PXFieldOptions.CommitChanges>;
}
...
export class POOrder extends PXView  {
	...
	@columnConfig({width: 140})	OrderNbr : PXFieldState;
